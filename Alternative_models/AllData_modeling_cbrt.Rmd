---
title: "2024 NH3-loss Statistical Models, cube root"
...
To account for non-normality, the response variable was transformed with a signed cube root transformation. We applied a constant of 4 to allow the analysis to include negative values.
...
model <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place + (1|Ref),
...
# Model A_Base 
m1_lmer_p1 <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
                   data=NH3predict)
...
The pairwise-comparisons of factor-level effects can be seen below. The comparisons are made to urea (in Fertiliser), Broadcast (in Application), Micromet (in Method), and Outdoor (in Place). The estimates are given in the cube root -scale.
...
m1_est_P <- emmeans(m1_lmer_p1, ~ Place, at=at)
m1_est_P <- data.frame(m1_est_P)

m1_est_P$emmean <- as.numeric(as.character(m1_est_P$emmean))
m1_est_P$emmean <- inv_signed_cube_root(m1_est_P$emmean)
m1_est_P$lower.CL <- inv_signed_cube_root(m1_est_P$lower.CL)
m1_est_P$upper.CL <- inv_signed_cube_root(m1_est_P$upper.CL)
...
ggplot(NH3predict_m2, aes(y=NH3loss, x=Application.rate)) + 
  ...
  geom_smooth(aes(y=(sign(M2_fits)*abs(M2_fits)^3)), method='lm', se=T, colour="black") +
...
m3_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place + pH_cat + Fertiliser:pH_cat + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
                   data=NH3predict)
summary(m3_lmer)
...
# Effect size
at <- list("Fertiliser"="urea+", "Application"="Broadcast", "Method"="Micromet")
m3_est_P <- emmeans(m3_lmer, ~ Place, at=at)
m3_est_P <- data.frame(m3_est_P)

m3_est_P$emmean <- as.numeric(as.character(m3_est_P$emmean))
m3_est_P$emmean <- inv_signed_cube_root(m3_est_P$emmean)
m3_est_P$lower.CL <- inv_signed_cube_root(m3_est_P$lower.CL)
m3_est_P$upper.CL <- inv_signed_cube_root(m3_est_P$upper.CL)
...
m3_estimates <- rbind(m3_estimates,
                      data.frame(Factor="Fertiliser:Soil pH",
                                 ...
                                 Effect=filter(m3_est_pHFe, contrast==".")$emmean,
...
ggplot(NH3predict_m4, aes(y=NH3loss, x=Clay)) + 
  ...
  geom_smooth(aes(y=(sign(M4_fits)*abs(M4_fits)^3)), method='lm', se=T, colour="black") +
...
ggplot(NH3predict_m5, aes(y=NH3loss, x=SOC)) + 
  theme_classic(base_size = 11) +
  geom_point(colour="gray75") +
  geom_smooth(aes(y=(sign(M5_fits)*abs(M5_fits^3))), method='lm', se=T, colour="black") +
...
m7b_lm <- lm(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ AirTemperature + offset(M1_fit), 
             weights=Weight, 
...
ggplot(NH3predict_m7_2, aes(x = AirTemperature, y = NH3loss)) +
  theme_classic(base_size=11) +
  geom_point(colour="gray75") +
  stat_smooth(aes(y=(sign(M7_fits)*abs(M7_fits)^3)), method="lm", colour="black") +
  labs(x="Air temperature", y="NH3 loss (%)")

ggplot(NH3predict_m8, aes(x = Rain.mean, y = NH3loss)) +
  theme_classic(base_size=11) +
  geom_point(colour="gray75") +
  stat_smooth(aes(y=(sign(M8_fits)*abs(M8_fits)^3)), method="lm", colour="black") +
...
ggplot(NH3predict_m10, aes(y=NH3loss, x=WaterPerDay)) + 
  theme_classic(base_size = 11) +
  geom_point(colour="gray75") +
  geom_smooth(method="lm", se=T, colour="black", aes(y=(sign(M10_fits)*abs(M10_fits)^3))) +
...
ggplot(NH3predict_m11, aes(y=NH3loss, x=Duration)) + 
  theme_classic(base_size = 11) +
  geom_point(colour="gray75") +
  geom_smooth(method="lm", se=T, colour="black", aes(y=(sign(M11_fits)*abs(M11_fits)^3))) +
...
mALL5_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place +  pH_cat + Fertiliser:pH_cat +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL5_est_F <- emmeans(mALL5_lmer, ~ Fertiliser, at=at)
mALL5_est_F  <- data.frame(mALL5_est_F)

mALL5_est_F$emmean <- as.numeric(as.character(mALL5_est_F$emmean))
mALL5_est_F$emmean <- inv_signed_cube_root(mALL5_est_F$emmean)
mALL5_est_F$lower.CL <- inv_signed_cube_root(mALL5_est_F$lower.CL)
mALL5_est_F$upper.CL <- inv_signed_cube_root(mALL5_est_F$upper.CL)
...
mALL5_est_A <- emmeans(mALL5_lmer, ~ Application, at=at)
mALL5_est_A <- data.frame(mALL5_est_A)

mALL5_est_A$emmean <- as.numeric(as.character(mALL5_est_A$emmean))
mALL5_est_A$emmean <- inv_signed_cube_root(mALL5_est_A$emmean)
mALL5_est_A$lower.CL <- inv_signed_cube_root(mALL5_est_A$lower.CL)
mALL5_est_A$upper.CL <- inv_signed_cube_root(mALL5_est_A$upper.CL)
...
mALL5_est_M <- emmeans(mALL5_lmer, ~ Method, at=at)
mALL5_est_M <- data.frame(mALL5_est_M)

mALL5_est_M$emmean <- as.numeric(as.character(mALL5_est_M$emmean))
mALL5_est_M$emmean <- inv_signed_cube_root(mALL5_est_M$emmean)
mALL5_est_M$lower.CL <- inv_signed_cube_root(mALL5_est_M$lower.CL)
mALL5_est_M$upper.CL <- inv_signed_cube_root(mALL5_est_M$upper.CL)
...
mALL5_est_P <- emmeans(mALL5_lmer, ~ Place, at=at)
mALL5_est_P <- data.frame(mALL5_est_P)

mALL5_est_P$emmean <- as.numeric(as.character(mALL5_est_P$emmean))
mALL5_est_P$emmean <- inv_signed_cube_root(mALL5_est_P$emmean)
mALL5_est_P$lower.CL <- inv_signed_cube_root(mALL5_est_P$lower.CL)
mALL5_est_P$upper.CL <- inv_signed_cube_root(mALL5_est_P$upper.CL)
...
# Effect size
at <- list("Fertiliser"="urea+", "Application"="Broadcast", "Method"="Micromet", "Place"="Outdoor")
mALL5_est_pH <- emmeans(mALL5_lmer, ~ pH_cat, at=at)
mALL5_est_pH <- data.frame(mALL5_est_pH)

mALL5_est_pH$emmean <- as.numeric(as.character(mALL5_est_pH$emmean))
mALL5_est_pH$emmean <- inv_signed_cube_root(mALL5_est_pH$emmean)
mALL5_est_pH$lower.CL <- inv_signed_cube_root(mALL5_est_pH$lower.CL)
mALL5_est_pH$upper.CL <- inv_signed_cube_root(mALL5_est_pH$upper.CL)
...
# Effect size
at <- list("Application"="Broadcast", "Method"="Micromet", "Place"="Outdoor")
mALL5_est_pHFe <- emmeans(mALL5_lmer, pairwise ~ pH_cat | Fertiliser, at=at)
mALL5_est_pHFe <- data.frame(mALL5_est_pHFe)

mALL5_est_pHFe$emmean <- as.numeric(as.character(mALL5_est_pHFe$emmean))
mALL5_est_pHFe$emmean <- inv_signed_cube_root(mALL5_est_pHFe$emmean)
mALL5_est_pHFe$lower.CL <- inv_signed_cube_root(mALL5_est_pHFe$lower.CL)
mALL5_est_pHFe$upper.CL <- inv_signed_cube_root(mALL5_est_pHFe$upper.CL)
...
mALL5_estimates <- rbind(mALL5_estimates, data.frame(Factor="Fertiliser:Soil pH",
                                                 ...
                                                 Effect=filter(mALL5_est_pHFe, contrast==".")$emmean,
...
mALLnoTemp_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place +                     pH_cat + Fertiliser:pH_cat + Clay + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL4_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place +  pH_cat + Fertiliser:pH_cat + AirTemperature +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL4b_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + pH_cat + Fertiliser:pH_cat + AirTemperature +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method + Place + 
...
# Effect sizes
at <- list("Application"="Broadcast", "Method"="Micromet", "Place"="Outdoor", "pH_cat"="normal")
mALL_est_F <- emmeans(mALL_lmer, ~ Fertiliser, at=at)
mALL_est_F  <- data.frame(mALL_est_F)

mALL_est_F$emmean <- as.numeric(as.character(mALL_est_F$emmean))
mALL_est_F$emmean <- inv_signed_cube_root(mALL_est_F$emmean)
mALL_est_F$lower.CL <- inv_signed_cube_root(mALL_est_F$lower.CL)
mALL_est_F$upper.CL <- inv_signed_cube_root(mALL_est_F$upper.CL)
...
# Effect sizes
at <- list("Fertiliser"="urea+", "Method"="Micromet", "Place"="Outdoor", "pH_cat"="normal")
mALL_est_A <- emmeans(mALL_lmer, ~ Application, at=at)
mALL_est_A <- data.frame(mALL_est_A)

mALL_est_A$emmean <- as.numeric(as.character(mALL_est_A$emmean))
mALL_est_A$emmean <- inv_signed_cube_root(mALL_est_A$emmean)
mALL_est_A$lower.CL <- inv_signed_cube_root(mALL_est_A$lower.CL)
mALL_est_A$upper.CL <- inv_signed_cube_root(mALL_est_A$upper.CL)
...
# Effect sizes
at <- list("Fertiliser"="urea+", "Application"="Broadcast", "Place"="Outdoor", "pH_cat"="normal")
mALL_est_M <- emmeans(mALL_lmer, ~ Method, at=at)
mALL_est_M <- data.frame(mALL_est_M)

mALL_est_M$emmean <- as.numeric(as.character(mALL_est_M$emmean))
mALL_est_M$emmean <- inv_signed_cube_root(mALL_est_M$emmean)
mALL_est_M$lower.CL <- inv_signed_cube_root(mALL_est_M$lower.CL)
mALL_est_M$upper.CL <- inv_signed_cube_root(mALL_est_M$upper.CL)
...
# Effect size
at <- list("Fertiliser"="urea+", "Application"="Broadcast", "Method"="Micromet", "pH_cat"="normal")
mALL_est_P <- emmeans(mALL_lmer, ~ Place, at=at)
mALL_est_P <- data.frame(mALL_est_P)

mALL_est_P$emmean <- as.numeric(as.character(mALL_est_P$emmean))
mALL_est_P$emmean <- inv_signed_cube_root(mALL_est_P$emmean)
mALL_est_P$lower.CL <- inv_signed_cube_root(mALL_est_P$lower.CL)
mALL_est_P$upper.CL <- inv_signed_cube_root(mALL_est_P$upper.CL)
...
# Effect size
at <- list("Fertiliser"="urea+", "Application"="Broadcast", "Method"="Micromet", "Place"="Outdoor")
mALL_est_pH <- emmeans(mALL_lmer, ~ pH_cat, at=at)
mALL_est_pH <- data.frame(mALL_est_pH)

mALL_est_pH$emmean <- as.numeric(as.character(mALL_est_pH$emmean))
mALL_est_pH$emmean <- inv_signed_cube_root(mALL_est_pH$emmean)
mALL_est_pH$lower.CL <- inv_signed_cube_root(mALL_est_pH$lower.CL)
mALL_est_pH$upper.CL <- inv_signed_cube_root(mALL_est_pH$upper.CL)
...
# Effect size
at <- list("Application"="Broadcast", "Method"="Micromet", "Place"="Outdoor")
mALL_est_pHFe <- emmeans(mALL_lmer, pairwise ~ pH_cat | Fertiliser, at=at)
mALL_est_pHFe <- data.frame(mALL_est_pHFe)

mALL_est_pHFe$emmean <- as.numeric(as.character(mALL_est_pHFe$emmean))
mALL_est_pHFe$emmean <- inv_signed_cube_root(mALL_est_pHFe$emmean)
mALL_est_pHFe$lower.CL <- inv_signed_cube_root(mALL_est_pHFe$lower.CL)
mALL_est_pHFe$upper.CL <- inv_signed_cube_root(mALL_est_pHFe$upper.CL)
...
mALL_estimates <- rbind(mALL_estimates, data.frame(Factor="Fertiliser:Soil pH",
                                                 ...
                                                 Effect=filter(mALL_est_pHFe, contrast==".")$emmean,
...
mALLTemp_Rain_lmer <- lmer(sign(NH3loss) * abs(NH3loss) ^ (1/3) ~ Fertiliser + Application + Method +                      pH_cat + Fertiliser:pH_cat +  AirTemperature + Rain.mean + AirTemperature *             Rain.mean +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
