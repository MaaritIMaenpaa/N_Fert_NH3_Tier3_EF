---
title: "2024 NH3-loss Statistical Models, outdoor only - sqrt"
...
model <- lmer(sqrt(NH3loss +4) ~ Fertiliser + Application + Method  + (1|Ref),
...
# Model A_Base
m1_lmer_p1 <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
                   data=NH3predict)

# Variance components
m1_var <- lmer(sqrt(NH3loss+4) ~ 1+
                 (1|Fertiliser) + 
                 (1|Application) + 
                 (1|Method)  + 
                 (1|Country) +
...
ggplot(NH3predict, aes(y=Ref, x=sqrt(NH3loss+4), colour=Fertiliser))+
...
merTools::RMSE.merMod(m1_lmer_p1)
AIC(m1_lmer_p1)
...
r.squaredGLMM(mALL_glmm)
performance::performance_rmse(mALL_glmm)
AIC(mALL_glmm)
...
m3_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method + pH_cat + Fertiliser:pH_cat + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
                   data=NH3predict)
summary(m3_lmer)
...
mALL1_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method +  pH_cat + Fertiliser:pH_cat +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL2_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  +                     pH_cat + Fertiliser:pH_cat + Application.rate + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL3_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  +  pH_cat + Fertiliser:pH_cat + AirTemperature +(1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL4_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  + 
...
mALL5_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  +  pH_cat + Fertiliser:pH_cat + Application.rate + AirTemperature + Rain.mean + AirTemperature * Rain.mean + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
...
mALL6_lmer <- lmer(sqrt(NH3loss+4) ~ Fertiliser + Application + Method  +  pH_cat + Fertiliser:pH_cat + Application.rate + AirTemperature + Rain.exp + AirTemperature * Rain.exp + (1|Ref),
                   weights=Weight,
                   control=lmerControl(optimizer="bobyqa"),
